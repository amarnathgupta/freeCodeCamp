...
The text `Indoor` should be located directly to the right of your `radio` button. Stelle sicher, dass zwischen dem Element und dem Text ein Leerzeichen ist. Du hast entweder den Text weggelassen oder einen Tippfehler gemacht.
...
Your `label` element should have an opening tag. Öffnende Tags haben diese Syntax: `<elementName>`.
